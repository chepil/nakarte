...
import {RadioLoader} from './radio-loader';
import './style.css';
...
L.Radio = L.GridLayer.extend({
        ...
        onAdd: function(map) {
            if (!this.loader) {
                this.loader = new RadioLoader(this.options.tilesBaseUrl, map);
            }
        ...
        updateHighlight: function() {
            ...
            if (place && !this.highlightedPlace) {
                this.highlightedPlace = {
                    ...
                    label: L.tooltip({className: 'radio-tooltip-wrapper'}, null)
                };
                this.highlightedPlace.label.setLatLng(this.lastMousePos);
                this.highlightedPlace.polygon.addTo(this._map).bringToBack();
                this.highlightedPlace.label.setContent(`<div class="radio-tooltip">${place.title}</div>`);
        ...
        onClick: function(e) {
            ...
            if (place) {
                ...
                openPopupWindow(url, 564, 'radio-details');
            }
        },
    }
);
